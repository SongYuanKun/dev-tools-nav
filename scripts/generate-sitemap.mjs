...
export function collectStaticUrls(root = ROOT) {
  ...
  return [
    ...
    ...blogUrls,
    ...aiUrls,
    { loc: `${BASE_URL}/tools/`, changefreq: "weekly", priority: "0.9" },
    { loc: `${BASE_URL}/tools/json/`, changefreq: "weekly", priority: "0.9" },
    { loc: `${BASE_URL}/tools/timestamp/`, changefreq: "monthly", priority: "0.85" },
    { loc: `${BASE_URL}/tools/cron/`, changefreq: "monthly", priority: "0.85" },
    { loc: `${BASE_URL}/tools/base64/`, changefreq: "monthly", priority: "0.85" },
