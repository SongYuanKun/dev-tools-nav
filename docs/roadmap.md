...
| 4 | 双站一致性巡检 | done | `npm run check:consistency` → A=18/18、B=8/8、C DIFF=0（2026-09-11）；脚本 [`consistency-gtr-x-ghpages.sh`](../scripts/consistency-gtr-x-ghpages.sh)；Pages 修复 `17d4e28` |
