(function () {
  ...
  function normalizeFooter() {
    ...
    footer.innerHTML = [
      ...
      '    </div>',
      '  </details>',
      '  <p class="footer-privacy">隐私：工具数据仅在浏览器内处理 · Umami 无 Cookie 的假名化访问统计 · 无广告</p>',
      ...
      '      <img src="' + localLink(prefix, 'assets/jetbrains-noncommercial.svg') + '" alt="JetBrains Non-Commercial Open Source" loading="lazy">',
      '    </a>',
      '  </p>',
