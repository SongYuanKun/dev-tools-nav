...
const TOOLS_DATA = [
  ...
  },
  {
    ...
    slug: "timestamp",
    name: "时间戳转换",
    description: "Unix 时间戳与日期互转，支持秒/毫秒自动识别，实时显示当前时间戳。",
    category: "online-tools",
    tags: ["时间戳", "Unix", "日期转换"],
    url: "tools/timestamp/",
  ...
  },
  {
    ...
    slug: "cron",
    name: "Cron 生成器",
    description: "可视化 Cron 表达式生成器，支持预设模板、中文说明和未来执行时间预览。",
    category: "online-tools",
    tags: ["Cron", "定时任务", "生成器"],
    url: "tools/cron/",
  ...
  },
  {
    ...
    slug: "base64",
    name: "Base64 编解码",
    description: "Base64、URL 编码、Unicode、HTML 实体编解码工具，支持多种格式一键转换。",
    category: "online-tools",
  ...
  },
  {
    ...
    slug: "jwt",
    name: "JWT 解码器",
    description: "在线 JSON Web Token 解析工具，实时解码 Header/Payload，检测 Token 过期状态。",
    category: "online-tools",
    tags: ["JWT", "Token", "解码"],
    url: "tools/jwt/",
