...
const TOOLS_DATA = [
  ...
  },
  {
    ...
    icon: "https://icon.horse/icon/www.doubao.com",
    featured: false,
    content: {
  ...
  },
  {
    ...
    tags: ["AI编程", "IDE", "国产"],
    url: "https://trae.ai/",
    icon: "https://icon.horse/icon/trae.ai",
    featured: false,
    content: {
  ...
  },
  {
    ...
    icon: "https://icon.horse/icon/stability.ai",
    featured: false,
    content: {
  ...
  },
  {
    ...
    icon: "https://icon.horse/icon/www.recraft.ai",
    featured: false,
    content: {
  ...
  },
  {
    ...
    icon: "https://icon.horse/icon/notion.so",
    featured: false,
    content: {
  ...
  },
  {
    ...
    icon: "https://icon.horse/icon/klingai.kuaishou.com",
    featured: false,
    content: {
  ...
  },
  {
    ...
    tags: ["AI音乐", "歌曲生成", "创作"],
    url: "https://suno.ai/",
    icon: "https://icon.horse/icon/suno.ai",
    featured: false,
    content: {
  ...
  // --- AI 开发平台 ---
  {
    ...
    icon: "https://icon.horse/icon/www.coze.cn",
    featured: false,
    content: {
  ...
  // ==================== 🛠️ 开发工具 ====================
  {
    ...
    icon: "https://icon.horse/icon/code.visualstudio.com",
    featured: true,
    content: {
  ...
  },
  {
    ...
    icon: "https://icon.horse/icon/postman.com",
    featured: true,
    content: {
  ...
  },
  {
    ...
    icon: "https://icon.horse/icon/hoppscotch.io",
    featured: false,
    content: {
  ...
  },
  {
    ...
    icon: "https://icon.horse/icon/jsonformatter.curiousconcept.com",
    featured: false,
    content: {
  ...
  },
  {
    ...
    icon: "https://icon.horse/icon/codesandbox.io",
    featured: true,
    content: {
  ...
  },
  {
    ...
    icon: "https://icon.horse/icon/stackblitz.com",
    featured: false,
    content: {
  ...
  },
  {
    ...
    icon: "https://icon.horse/icon/transform.tools",
    featured: false,
    content: {
  ...
  },
  {
    ...
    icon: "https://icon.horse/icon/www.cloudflare.com",
    featured: true,
    content: {
  ...
  },
  {
    ...
    icon: "https://icon.horse/icon/namecheap.com",
    featured: false,
    content: {
  ...
  },
  {
    ...
    icon: "https://icon.horse/icon/porkbun.com",
    featured: false,
    content: {
  ...
  },
  {
    ...
    icon: "https://icon.horse/icon/railway.app",
    featured: false,
    content: {
  ...
  },
  {
    ...
    icon: "https://icon.horse/icon/letsencrypt.org",
    featured: false,
    content: {
  ...
  // ==================== 🔒 安全工具 ====================
  {
    ...
    icon: "https://icon.horse/icon/www.ssllabs.com",
    featured: true,
    content: {
  ...
  },
  {
    ...
    icon: "https://icon.horse/icon/www.virustotal.com",
    featured: true,
    content: {
  ...
  },
  {
    ...
    icon: "https://icon.horse/icon/haveibeenpwned.com",
    featured: false,
    content: {
  ...
  },
  {
    ...
    icon: "https://icon.horse/icon/securityheaders.com",
    featured: false,
    content: {
  ...
  },
  {
    ...
    icon: "https://icon.horse/icon/bitwarden.com",
    featured: false,
    content: {
  ...
  },
  {
    ...
    icon: "https://icon.horse/icon/observatory.mozilla.org",
    featured: false,
    content: {
  ...
  // ==================== 📊 运维监控 ====================
  {
    ...
    icon: "https://icon.horse/icon/uptimerobot.com",
    featured: true,
    content: {
  ...
  },
  {
    ...
    icon: "https://icon.horse/icon/grafana.com",
    featured: true,
    content: {
  ...
  },
  {
    ...
    icon: "https://icon.horse/icon/www.datadoghq.com",
    featured: false,
    content: {
  ...
  },
  {
    ...
    icon: "https://icon.horse/icon/betterstack.com",
    featured: false,
    content: {
  ...
  },
  {
    ...
    icon: "https://icon.horse/icon/pagespeed.web.dev",
    featured: false,
    content: {
  ...
  },
  {
    ...
    icon: "https://icon.horse/icon/cssgradient.io",
    featured: false,
    content: {
  ...
  },
  {
    ...
    icon: "https://icon.horse/icon/squoosh.app",
    featured: false,
    content: {
  ...
  // ==================== 🧰 在线工具（自研，站内页面） ====================
  {
    ...
    slug: "",
    name: "在线工具中心",
    description: "统一入口：搜索、筛选、最近/收藏，一站式找到你要的在线工具。",
  ...
  },
  {
    ...
    slug: "json",
    name: "JSON 格式化",
    description: "在线 JSON 格式化、校验、压缩，树形视图、JSON Path、YAML 互转、双 JSON Diff，注释/尾逗号容错。",
    category: "online-tools",
    tags: ["JSON", "格式化", "校验"],
    url: "tools/json/",
    legacyUrl: "pages/tools/json.html",
    icon: "📋",
    featured: true,
    content: null,
  },
  {
    ...
    slug: "timestamp",
    name: "时间戳转换",
    description: "Unix 时间戳与日期互转，秒/毫秒/微秒/纳秒、多时区、批量转换、时间差与代码片段。",
    category: "online-tools",
    tags: ["时间戳", "Unix", "日期转换"],
    url: "tools/timestamp/",
    legacyUrl: "pages/tools/timestamp.html",
    icon: "⏱️",
    featured: true,
    content: null,
  },
  {
    ...
    slug: "cron",
    name: "Cron 生成器",
    description: "Linux 五段 / Quartz 六段 Cron 可视化生成，中文说明、执行预览与 K8s/GitHub Actions 片段。",
    category: "online-tools",
    tags: ["Cron", "定时任务", "生成器"],
    url: "tools/cron/",
    legacyUrl: "pages/tools/cron.html",
    icon: "⏰",
    featured: true,
    content: null,
  },
  {
    ...
    slug: "base64",
    name: "Base64 编解码",
    description: "Base64/URL/Unicode/HTML 编解码，Hex 转换、SHA 摘要、文件 Hash 与 Data URL 图片预览。",
    category: "online-tools",
    tags: ["Base64", "URL编码", "编解码"],
    url: "tools/base64/",
  ...
  },
  {
    ...
    slug: "jwt",
    name: "JWT 解码器",
    description: "JWT 解码、HS/RS 验签与 Token 生成，标准声明中文说明与安全审计清单。",
    category: "online-tools",
    tags: ["JWT", "Token", "解码"],
    url: "tools/jwt/",
  ...
  },
  {
    ...
    slug: "sql-formatter",
    name: "SQL 格式化",
    description: "SQL 格式化/压缩/结构分析，MySQL/PostgreSQL 方言，表名与风险提醒。",
    category: "online-tools",
    tags: ["SQL", "格式化", "美化"],
  ...
  },
  {
    ...
    slug: "regex",
    name: "正则测试",
    description: "正则实时匹配高亮，26+ 模板，Python/Go/JS/Java 代码生成与替换预览。",
    category: "online-tools",
    tags: ["正则表达式", "Regex", "匹配"],
    url: "tools/regex/",
  ...
  },
  {
    ...
    slug: "uuid",
    name: "UUID 生成器",
    description: "批量生成 UUID v4 / v7，支持大小写、连字符格式，一键复制列表。",
    category: "online-tools",
    tags: ["UUID", "GUID", "生成器"],
    url: "tools/uuid/",
    legacyUrl: "pages/tools/uuid.html",
    icon: "🆔",
    featured: true,
    content: null,
  },
  {
    ...
    slug: "diff",
    name: "文本 Diff",
    description: "左右文本行级对比，增删高亮、统计行数，导出 Unified Diff。",
    category: "online-tools",
    tags: ["Diff", "对比", "文本"],
    url: "tools/diff/",
    legacyUrl: "pages/tools/diff.html",
    icon: "📊",
    featured: false,
    content: null,
  },
  {
    ...
    slug: "color",
    name: "颜色转换",
    description: "HEX/RGB/HSL/HWB 互转，WCAG 对比度检测，复制 CSS 变量。",
    category: "online-tools",
    tags: ["颜色", "HEX", "对比度"],
    url: "tools/color/",
    legacyUrl: "pages/tools/color.html",
    icon: "🎨",
    featured: false,
    content: null,
  },
